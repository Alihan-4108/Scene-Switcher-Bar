...
<p align="center">
  <img src="docs~/images/toolbar.png" alt="Scene buttons in the main toolbar" width="800">
</p>
...
1. Open **Tools > Scene Toolbar Settings**.
   ...
   <p align="center">
     <img src="docs~/images/window.png" alt="Settings window" width="500">
   </p>
...
2. Tick the scenes you want to see on the toolbar.
   ...
   - **Display** lets you switch between **Buttons** (each scene gets its own button) and **Dropdown** (all scenes grouped under one **Scenes** button).
     ...
     <p align="center">
       <img src="docs~/images/dropdown.png" alt="Dropdown mode" width="800">
     </p>
